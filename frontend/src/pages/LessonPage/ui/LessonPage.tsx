...
const LessonPage = () => {
  ...
  const lesson = location.state as { id: number; title: string; description: string; content: string };
    ...
    <Container maxWidth="md" className={styles.lessonContainer}>
      <Paper elevation={3} className={styles.lessonPaper}>
        <Box className={styles.lessonHeader}>
          ...
          <img src="/path/to/illustration.png" alt="Illustration" className={styles.lessonIllustration} />
        </Box>
        <Typography variant="body1" className={styles.lessonDescription}>
          {lesson.description}
        </Typography>
        <Typography variant="body2" className={styles.lessonContent}>
          {lesson.content}
        </Typography>
      </Paper>
    </Container>
